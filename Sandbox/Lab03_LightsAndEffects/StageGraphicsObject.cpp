...
bool StageGraphicsObject::Initialize()
{
    ...
    for (size_t q = 0; q < 40; q += 4)
    {
        ...
        {
            idx0 = AddVertex({ x + q,     0, z + w     }, { q / 10.f,       w / 10.f       }, { 0, 0, 1 });
            idx1 = AddVertex({ x + q + 4, 0, z + w     }, { (q + 4) / 10.f, w / 10.f       }, { 0, 0, 1 });
            idx2 = AddVertex({ x + q + 4, 0, z + w + 4 }, { (q + 4) / 10.f, (w + 4) / 10.f }, { 0, 0, 1 });
            idx3 = AddVertex({ x + q,     0, z + w + 4 }, { q / 10.f,       (w + 4) / 10.f }, { 0, 0, 1 });
