...
std::string instancedPhongVertex = R"raw(
#version 430 core
...
layout(location = 2) out mat4 out_instance_model_matrix;
...
std::string instancedPhongFragment = R"raw(
#version 430 core
...
/* END INPUT IDENTITIES */ 
    ...
    temp_00CA5008_0 = view_matrix * model_matrix * instance_model_matrix * vec4(xyz_position, 1);
...
std::map<unsigned, GlEngine::ShaderFactory::ShaderProp*> instancedPhongProps = {
    { 0, &prop_ViewMatrix },
    { 1, &prop_ModelMatrix },
...
ShaderSource instancedPhongSource = {
    &instancedPhongVertex,
    nullptr,
    nullptr,
    nullptr,
    &instancedPhongFragment
};
