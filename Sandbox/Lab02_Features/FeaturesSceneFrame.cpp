...
bool FeaturesSceneFrame::Initialize()
{
    ...
    auto torus1 = OrbitingLight::Create(this, "PhongTorus1", phongMat1, pointLight1, { 0, 0, 1 });
    ...
    auto torus2 = OrbitingLight::Create(this, "PhongTorus2", phongMat2, pointLight2, { 1, 0, 0 });
    ...
    auto torus3 = OrbitingLight::Create(this, "PhongTorus3", phongMat3, pointLight3, { 0, 1, 0 }, 3.f, .5f);
    ...
    auto teapot = OrbitingLight::Create(this, "PhongTorus4", phongMat4, "Resources/teapot.obj", pointLight4, Vector<3> { 0, 1, 0 });
    ...
    auto discard = OrbitingLight::Create(this, "DiscardTorus", discardMaterial, pointLight5, { 1, 0, 0 });
