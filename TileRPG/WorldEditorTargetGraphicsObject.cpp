...
namespace TileRPG
{
    WorldEditorTargetGraphicsObject::WorldEditorTargetGraphicsObject()
    {
    }
    WorldEditorTargetGraphicsObject::~WorldEditorTargetGraphicsObject()
    {
    ...
    {
        auto texture = GlEngine::Texture::FromFile("Textures/world-edit-select.png"s, GlEngine::TextureFlag::Translucent);
